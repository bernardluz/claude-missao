...
Mostre a SPEC ao usuário. Aprovada, grave-a num arquivo do projeto e rode o workflow `missao` com `spec` apontando para
ele (e `aceite`, se os critérios estiverem em outro lugar).
